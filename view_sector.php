...
<div id="block-platform-rusearch" class="block block-platform">
  ...
  <div class="region-wrapper clearfix masthead menu-singleheight"><div class="region-inner">
    <a class="logo" href="f1.html" style="background: url(lg.png)" width="256" height="70">
    </a>
          <a class="site-name" href="f1.html" title="mygovpolicy">मेरा देश बदल रहा है,
आगे बढ़ रहा है|</a>
  ...
  <ul class="menu"><li class="first leaf active menu-mlid-423"><a href="f1.html" title="" class="active">Home</a></li>
<li class="leaf menu-mlid-403"><a href="f2.html" >About mygovpolicy</a></li>
<li class="expanded menu-mlid-409">View Policies<ul class="menu">
<li class="first leaf has-children menu-mlid-404"><a href="view_alpha.php">Alphabetical List</a></li>
<li class="leaf menu-mlid-407"><a href="view_year.php">Yearwise</a></li>
<li class="last leaf menu-mlid-408"><a href="view_sector.php">Sectorwise</a></li>
</ul></li>
<li class="expanded menu-mlid-426"><a href="3.php" title="login">Login/Signup</a></li>
...
if(!$db)
{
 ...
 /*Create query*/ 
$qry = "SELECT sect_name,pol_name,year,main_obj,descp,off_site,dept_name,minister_name FROM policy,sector,dept WHERE policy.sector_id=sector.sect_id AND policy.dept_id=dept.dept_id ORDER BY sect_name"; 

/*Execute query*/ 
$result = mysql_query($qry);
echo '<br/><br/><br/><center><h1> - POLICIES SECTORWISE - </h1></center><br/><table border="1" >  
