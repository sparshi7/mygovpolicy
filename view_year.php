...
if(!$db)
{
 ...
 /*Create query*/ 
$qry = "SELECT year,sect_name,pol_name,main_obj,descp,off_site,dept_name,minister_name FROM policy,sector,dept WHERE policy.sector_id=sector.sect_id AND policy.dept_id=dept.dept_id order BY year desc"; 

/*Execute query*/ 
$result = mysql_query($qry);
echo '<br/><br/><br/><center><h1> - POLICIES YEARWISE - </h1></center><br/><table border="1" >  
