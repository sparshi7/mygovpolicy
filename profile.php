...
//Check if tde user is autdenticated first. Or else redirect to login page 
if(isset($_SESSION['IS_AUTHENTICATED']) && $_SESSION['IS_AUTHENTICATED'] == 1 && $_SESSION['aadhar']){ 
...
$qry ='SELECT aadhar_no,f_name,l_name,fh_name,aadhar.dob,TIMESTAMPDIFF(YEAR,aadhar.dob,CURDATE()),gender,phone,address,area,income,category,mail_id,student,employed FROM aadhar,profile WHERE aadhar_no=aadhar_num and aadhar_no='.$_SESSION['aadhar'] ; 


$result = mysql_query($qry);
echo '<br/><br/><br/><center><h1> - MY PROFILE - </h1></center><br/><center><table  border="1"> ';
while ($row = mysql_fetch_assoc($result))
{ 
echo '<center><tr><td> Aadhar Card No. </td><td>'.$row['aadhar_no'].'</td></tr>
<tr><td> First Name </td><td>'.$row['f_name'].'</td></tr>
<tr><td> Last Name </td>  <td>'.$row['l_name'].'</td></tr>
<tr><td> Guardians Name </td><td>'.$row['fh_name'].'</td></tr>
<tr><td> Date Of Birth </td><td>'.$row['dob'].'</td></tr>
<tr><td> Age </td><td>'.$row['TIMESTAMPDIFF(YEAR,aadhar.dob,CURDATE())'].'</td></tr>
<tr><td> Gender </td><td>'.$row['gender'].'</td></tr>
<tr><td> Phone </td><td>'.$row['phone'].'<a href="updatephone.php" style="text-align:right">  UPDATE</a></td></tr>
<tr><td> Address </td> <td>'.$row['address'].'</td></tr>
<tr><td> Area </td><td>'.$row['area'].'<a href="updatearea.php" style="text-align:right">  UPDATE</a></td></tr>
<tr><td> Income </td><td>'.$row['income'].'<a href="updateincome.php" style="text-align:right">  UPDATE</a></td></tr>
<tr><td> Category </td><td>'.$row['category'].'</td></tr>
<tr><td> Email </td><td>'.$row['mail_id'].'<a href="updateemail.php" style="text-align:right">  UPDATE</a></td></tr>
<tr><td> Student </td><td>'.$row['student'].'<a href="updatestudent.php" style="text-align:right">  UPDATE</a></td></tr>
<tr><td> Employed </td><td>'.$row['employed'].'<a href="updateemployed.php" style="text-align:right">  UPDATE</a></td></tr>';
}
echo '</table></center>';

echo '<br/><br/>';
echo '<h3><a href="mypolicies.php"><center>VIEW YOUR APPLICABLE POLICIES HERE</center></a><br/><br/><br/></h3>';
